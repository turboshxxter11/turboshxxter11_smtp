...
class TurboSxStaticAttach:
    def __init__(self,from_address,to,subject,body,pwd,smtp_server,smtp_port,path,attach_StaticPDFPath="",mail_type="mail",body_type="text"):
        self.from_address=from_address
        self.to=to
        self.subject=subject
        self.body=body
        ...
        self.smtp_port=smtp_port
        self.path=path
        self.attach_StaticPDFPath=attach_StaticPDFPath
...
#                                     print("Unable to Connect to the smtp server: "+smtp_server+" at port: "+smtp_port)
                            ...
                            attach_StaticPDFPath=attach_StaticPDFPath_bkp
                            attach_StaticPDFPath=attach_StaticPDFPath.replace("\\","\\\\")
...
try:
    ...
    if (code == '001'):    
        while x:
            ...
            print("Press 5 to Shoot(with Static Attachment) (inbound -> outbound):")
