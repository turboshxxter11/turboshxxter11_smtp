                    ...
                    for line in file:
                        if(count==0):
                            ...
                            try:
                                ...
                                print("-> Success", end=" : ")
                                print(smtp_server)
                                file_write.write(ln[0]+","+ln[1]+","+ln[2]+","+ln[3]+","+ln[4]+",\""+ln[5]+"\"\n")
                            except Exception as e:
                                print("-> Fail ", end=" : ")
                                ...
                                file_write_f.write(ln[0]+","+ln[1]+","+ln[2]+","+ln[3]+","+ln[4]+",\""+ln[5]+"\","+smtp_server+","+from_address+"\n")
...
#                                     print("Unable to Connect to the smtp server: "+smtp_server+" at port: "+smtp_port)
                            ...
                            try:
                                ...
                                print(smtp_server)
                                file_write.write(ln[0]+","+ln[1]+","+ln[2]+","+ln[3]+","+ln[4]+",\""+ln[5]+"\"\n")
                                file_write_up.write(ln[0]+","+ln[1]+","+ln[2]+","+ln[3]+","+ln[4]+","+ln[5]+"\n")
                            except Exception as e:
...
class splitFeeds:
    ...
    def performSplit(self):
        ...
        for line_data in file_data:
            ...
            if(count%(n)==0):
                ...
                file_write.write(ls[k].strip().replace(',','|')+"\n")
                print(ls[k])
    ...
    def csv2psv(self):
        ...
        with open(self.feeds_path+"\\stage1_data.csv", newline='') as in_file:
            with open(self.feeds_path+"\\psv_data.csv", 'w', newline='') as out_file:
